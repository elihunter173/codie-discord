...
// TODO: Switch this to be a config file?? I don't know. it doesn't play nice with options
// TODO: Languages codes should match what Discord uses for syntax highlighting. Discord uses
// highlight.js, so the language codes should come from here:
// https://github.com/highlightjs/highlight.js/blob/master/SUPPORTED_LANGUAGES.md.
// Further, highlight.js does case insensitive comparions for languages so we should also do
// case-insensitive comparisons:
// https://github.com/highlightjs/highlight.js/blob/3a2934d7e7af99631527bf55465fa229522735b9/src/highlight.js#L816-L819
codegen_languages! {
    Bash = {
        display = "Bash",
        codes = "bash",
